package com.baris.ybs4a_hafta11;
...
import com.baris.ybs4a_hafta11.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(51.5287398, -0.2664031);
        mMap.addMarker(new MarkerOptions().position(sydney).title("London"));
